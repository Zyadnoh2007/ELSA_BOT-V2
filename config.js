...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("201276638909,201116117654")
...
global.sudo = process.env.SUDO || '201276638909'
global.devs = '201276638909';
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? '*『❄️┇❆ 𝑍𝐸𝑍𝛩 𝐵𝛩𝑇 ❆┇❄️』*' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? '𝑍𝐸𝑍𝛩 👑' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_INFO.split(";")[0] === undefined ? '*『❄️┇❆ 𝑍𝐸𝑍𝛩 𝐵𝛩𝑇 ❆┇❄️』*' : process.env.PACK_INFO.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS === undefined ? false : process.env.AUTO_READ_STATUS,
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? '𝑍𝐸𝑍𝛩 👑' : process.env.PACK_INFO.split(";")[1],
